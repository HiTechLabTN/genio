 ...
 */
function PhysicsDriver({ onPosition, target }: { onPosition: (x: number, y: number) => void; target: React.MutableRefObject<{ x: number; y: number; z: number }> }) {
...
export default function MascotStage({ chat, agentStatus, sendPrompt, onSwitchToTechnicalMode }: MascotStageProps) {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-[#020B1E]">
      ...
      >
        <ErrorBoundary name="CyberAvatar-mascotStage">
