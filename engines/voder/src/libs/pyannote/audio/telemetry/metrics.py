...
# Try to import opentelemetry, if it fails, create a stub
try:
    ...
    # Create stub classes and functions for when opentelemetry is not available
    class StubMetrics:
        def set_meter_provider(self, *args, **kwargs): pass
